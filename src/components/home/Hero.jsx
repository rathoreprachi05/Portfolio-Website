    ...
    <section className="relative w-full h-screen grid grid-cols-1 md:grid-cols-2 overflow-hidden selection:bg-[#E86565]/30 selection:text-slate-900">
      ...
      >
        ...
        <div className="hidden md:flex items-center justify-end gap-6 px-16 pt-10 pointer-events-auto">
          {/* GitHub Icon */}
          <a href="https://github.com/" target="_blank" rel="noreferrer" className="text-white hover:text-[#E86565] transition-colors duration-300">
          ...
          {/* LinkedIn Icon */}
          <a href="https://linkedin.com/" target="_blank" rel="noreferrer" className="text-white hover:text-[#E86565] transition-colors duration-300">
          ...
          <a href="https://substack.com/" target="_blank" rel="noreferrer" className="text-white hover:text-[#E86565] transition-colors duration-300">
          ...
          {/* Instagram Icon */}
          <a href="https://instagram.com/" target="_blank" rel="noreferrer" className="text-white hover:text-[#E86565] transition-colors duration-300">
